...
class sut(object):
    def act0(self):
        ...
        include "main.py"
        '''
        self.__test.append(('''include "main.py" ''',self.guard0,self.act0))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''include "main.py" '''))
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''// Test depositing money ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test depositing money '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act2(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard2,self.act2))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''none '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard2(self):
        ...
        deposit : (float)
        '''
        return (deposit : (float))
    
    def act3(self):
        '''
        // Test withdrawing money
        '''
        self.__test.append(('''// Test withdrawing money ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test withdrawing money '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act4(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard4,self.act4))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard4(self):
        ...
        withdraw : (float)
        '''
        return (withdraw : (float))
    
    def act5(self):
        '''
        // Test transferring funds
        '''
        self.__test.append(('''// Test transferring funds ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test transferring funds '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act6(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard6,self.act6))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard6(self):
        '''
        transfer : (BankAccount, float)
        '''
        return (transfer : (BankAccount, float))
    
    def act7(self):
        '''
        // Test checking account balance
        '''
        self.__test.append(('''// Test checking account balance ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test checking account balance '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act9(self):
        ...
        '''
        self.__test.append(('''// Test calculating interest ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test calculating interest '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act11(self):
        ...
        '''
        self.__test.append(('''// Test viewing transaction history ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test viewing transaction history '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act12(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard12,self.act12))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act13(self):
        ...
        '''
        self.__test.append(('''// Test applying for a loan ''',self.guard13,self.act13))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test applying for a loan '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act14(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard14,self.act14))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard14(self):
        '''
        apply_for_loan : (float)
        '''
        return (apply_for_loan : (float))
    
    def act15(self):
        '''
        // Test repaying a loan
        '''
        self.__test.append(('''// Test repaying a loan ''',self.guard15,self.act15))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test repaying a loan '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act16(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard16,self.act16))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard16(self):
        ...
        repay_loan : (float)
        '''
        return (repay_loan : (float))
    
    def act17(self):
        '''
        // Test checking remaining loan
        '''
        self.__test.append(('''// Test checking remaining loan ''',self.guard17,self.act17))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test checking remaining loan '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act18(self):
        ...
        none
        '''
        self.__test.append(('''none ''',self.guard18,self.act18))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def guard18(self):
        '''
        check_remaining_loan :
        '''
        return (check_remaining_loan :)
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''include "main.py" ''')
        self.__actionClasses.append('''// Test depositing money ''')
        self.__actionClasses.append('''deposit : (float) -> none ''')
        self.__actionClasses.append('''// Test withdrawing money ''')
        self.__actionClasses.append('''withdraw : (float) -> none ''')
        self.__actionClasses.append('''// Test transferring funds ''')
        self.__actionClasses.append('''transfer : (BankAccount, float) -> none ''')
        self.__actionClasses.append('''// Test checking account balance ''')
        self.__actionClasses.append('''check_balance : -> none ''')
        self.__actionClasses.append('''// Test calculating interest ''')
        self.__actionClasses.append('''calculate_interest : -> none ''')
        self.__actionClasses.append('''// Test viewing transaction history ''')
        self.__actionClasses.append('''view_transaction_history : -> none ''')
        self.__actionClasses.append('''// Test applying for a loan ''')
        self.__actionClasses.append('''apply_for_loan : (float) -> none ''')
        self.__actionClasses.append('''// Test repaying a loan ''')
        self.__actionClasses.append('''repay_loan : (float) -> none ''')
        self.__actionClasses.append('''// Test checking remaining loan ''')
        self.__actionClasses.append('''check_remaining_loan : -> none ''')
        self.__dependencies = {}
        self.__dependencies['''include "main.py" '''] = []
        self.__dependencies['''// Test depositing money '''] = []
        self.__dependencies['''deposit : (float) -> none '''] = []
        self.__dependencies['''// Test withdrawing money '''] = []
        self.__dependencies['''withdraw : (float) -> none '''] = []
        self.__dependencies['''// Test transferring funds '''] = []
        self.__dependencies['''transfer : (BankAccount, float) -> none '''] = []
        self.__dependencies['''// Test checking account balance '''] = []
        self.__dependencies['''check_balance : -> none '''] = []
        self.__dependencies['''// Test calculating interest '''] = []
        self.__dependencies['''calculate_interest : -> none '''] = []
        self.__dependencies['''// Test viewing transaction history '''] = []
        self.__dependencies['''view_transaction_history : -> none '''] = []
        self.__dependencies['''// Test applying for a loan '''] = []
        self.__dependencies['''apply_for_loan : (float) -> none '''] = []
        self.__dependencies['''// Test repaying a loan '''] = []
        self.__dependencies['''repay_loan : (float) -> none '''] = []
        self.__dependencies['''// Test checking remaining loan '''] = []
        self.__dependencies['''check_remaining_loan : -> none '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''include "main.py" ''',self.guard0,self.act0))
        self.__names['''include "main.py" '''] = ('''include "main.py" ''',self.guard0,self.act0)
        self.__actionClass['''include "main.py" '''] = '''include "main.py" '''
        self.__orderings['''include "main.py" '''] = 1
        self.__okExcepts['''include "main.py" '''] = ''''''
        
        self.__actions.append(('''// Test depositing money ''',self.guard1,self.act1))
        self.__names['''// Test depositing money '''] = ('''// Test depositing money ''',self.guard1,self.act1)
        self.__actionClass['''// Test depositing money '''] = '''// Test depositing money '''
        self.__orderings['''// Test depositing money '''] = 2
        self.__okExcepts['''// Test depositing money '''] = ''''''
        
        self.__actions.append(('''none ''',self.guard2,self.act2))
        self.__names['''none '''] = ('''none ''',self.guard2,self.act2)
        self.__actionClass['''none '''] = '''deposit : (float) -> none '''
        self.__orderings['''none '''] = 3
        self.__okExcepts['''none '''] = ''''''
        
        self.__actions.append(('''// Test withdrawing money ''',self.guard3,self.act3))
        self.__names['''// Test withdrawing money '''] = ('''// Test withdrawing money ''',self.guard3,self.act3)
        self.__actionClass['''// Test withdrawing money '''] = '''// Test withdrawing money '''
        self.__orderings['''// Test withdrawing money '''] = 4
        self.__okExcepts['''// Test withdrawing money '''] = ''''''
        
        self.__actions.append(('''none  ''',self.guard4,self.act4))
        self.__names['''none  '''] = ('''none  ''',self.guard4,self.act4)
        self.__actionClass['''none  '''] = '''withdraw : (float) -> none '''
        self.__orderings['''none  '''] = 5
        self.__okExcepts['''none  '''] = ''''''
        self.__refCode['''none  '''] = []
        self.__refCode['''none  '''].append('''none ''')
        
        self.__actions.append(('''// Test transferring funds ''',self.guard5,self.act5))
        self.__names['''// Test transferring funds '''] = ('''// Test transferring funds ''',self.guard5,self.act5)
        self.__actionClass['''// Test transferring funds '''] = '''// Test transferring funds '''
        self.__orderings['''// Test transferring funds '''] = 6
        self.__okExcepts['''// Test transferring funds '''] = ''''''
        
        self.__actions.append(('''none   ''',self.guard6,self.act6))
        self.__names['''none   '''] = ('''none   ''',self.guard6,self.act6)
        self.__actionClass['''none   '''] = '''transfer : (BankAccount, float) -> none '''
        self.__orderings['''none   '''] = 7
        self.__okExcepts['''none   '''] = ''''''
        self.__refCode['''none   '''] = []
        self.__refCode['''none   '''].append('''none ''')
        
        self.__actions.append(('''// Test checking account balance ''',self.guard7,self.act7))
        self.__names['''// Test checking account balance '''] = ('''// Test checking account balance ''',self.guard7,self.act7)
        self.__actionClass['''// Test checking account balance '''] = '''// Test checking account balance '''
        self.__orderings['''// Test checking account balance '''] = 8
        self.__okExcepts['''// Test checking account balance '''] = ''''''
        
        self.__actions.append(('''none    ''',self.guard8,self.act8))
        self.__names['''none    '''] = ('''none    ''',self.guard8,self.act8)
        self.__actionClass['''none    '''] = '''check_balance : -> none '''
        self.__orderings['''none    '''] = 9
        self.__okExcepts['''none    '''] = ''''''
        self.__refCode['''none    '''] = []
        self.__refCode['''none    '''].append('''none ''')
        
        self.__actions.append(('''// Test calculating interest ''',self.guard9,self.act9))
        self.__names['''// Test calculating interest '''] = ('''// Test calculating interest ''',self.guard9,self.act9)
        self.__actionClass['''// Test calculating interest '''] = '''// Test calculating interest '''
        self.__orderings['''// Test calculating interest '''] = 10
        self.__okExcepts['''// Test calculating interest '''] = ''''''
        
        self.__actions.append(('''none     ''',self.guard10,self.act10))
        self.__names['''none     '''] = ('''none     ''',self.guard10,self.act10)
        self.__actionClass['''none     '''] = '''calculate_interest : -> none '''
        self.__orderings['''none     '''] = 11
        self.__okExcepts['''none     '''] = ''''''
        self.__refCode['''none     '''] = []
        self.__refCode['''none     '''].append('''none ''')
        
        self.__actions.append(('''// Test viewing transaction history ''',self.guard11,self.act11))
        self.__names['''// Test viewing transaction history '''] = ('''// Test viewing transaction history ''',self.guard11,self.act11)
        self.__actionClass['''// Test viewing transaction history '''] = '''// Test viewing transaction history '''
        self.__orderings['''// Test viewing transaction history '''] = 12
        self.__okExcepts['''// Test viewing transaction history '''] = ''''''
        
        self.__actions.append(('''none      ''',self.guard12,self.act12))
        self.__names['''none      '''] = ('''none      ''',self.guard12,self.act12)
        self.__actionClass['''none      '''] = '''view_transaction_history : -> none '''
        self.__orderings['''none      '''] = 13
        self.__okExcepts['''none      '''] = ''''''
        self.__refCode['''none      '''] = []
        self.__refCode['''none      '''].append('''none ''')
        
        self.__actions.append(('''// Test applying for a loan ''',self.guard13,self.act13))
        self.__names['''// Test applying for a loan '''] = ('''// Test applying for a loan ''',self.guard13,self.act13)
        self.__actionClass['''// Test applying for a loan '''] = '''// Test applying for a loan '''
        self.__orderings['''// Test applying for a loan '''] = 14
        self.__okExcepts['''// Test applying for a loan '''] = ''''''
        
        self.__actions.append(('''none       ''',self.guard14,self.act14))
        self.__names['''none       '''] = ('''none       ''',self.guard14,self.act14)
        self.__actionClass['''none       '''] = '''apply_for_loan : (float) -> none '''
        self.__orderings['''none       '''] = 15
        self.__okExcepts['''none       '''] = ''''''
        self.__refCode['''none       '''] = []
        self.__refCode['''none       '''].append('''none ''')
        
        self.__actions.append(('''// Test repaying a loan ''',self.guard15,self.act15))
        self.__names['''// Test repaying a loan '''] = ('''// Test repaying a loan ''',self.guard15,self.act15)
        self.__actionClass['''// Test repaying a loan '''] = '''// Test repaying a loan '''
        self.__orderings['''// Test repaying a loan '''] = 16
        self.__okExcepts['''// Test repaying a loan '''] = ''''''
        
        self.__actions.append(('''none        ''',self.guard16,self.act16))
        self.__names['''none        '''] = ('''none        ''',self.guard16,self.act16)
        self.__actionClass['''none        '''] = '''repay_loan : (float) -> none '''
        self.__orderings['''none        '''] = 17
        self.__okExcepts['''none        '''] = ''''''
        self.__refCode['''none        '''] = []
        self.__refCode['''none        '''].append('''none ''')
        
        self.__actions.append(('''// Test checking remaining loan ''',self.guard17,self.act17))
        self.__names['''// Test checking remaining loan '''] = ('''// Test checking remaining loan ''',self.guard17,self.act17)
        self.__actionClass['''// Test checking remaining loan '''] = '''// Test checking remaining loan '''
        self.__orderings['''// Test checking remaining loan '''] = 18
        self.__okExcepts['''// Test checking remaining loan '''] = ''''''
        
        self.__actions.append(('''none         ''',self.guard18,self.act18))
        self.__names['''none         '''] = ('''none         ''',self.guard18,self.act18)
        self.__actionClass['''none         '''] = '''check_remaining_loan : -> none '''
        self.__orderings['''none         '''] = 19
        self.__okExcepts['''none         '''] = ''''''
        self.__refCode['''none         '''] = []
        self.__refCode['''none         '''].append('''none ''')
